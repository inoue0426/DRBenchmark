...
# drug_subfeat, cline_subfeat, CDR_pairs, drug_dim, drug_compo_elem, cline_compos_elem = (
#     data_process()
# )
...
def validation(drug_loader_valid, cline_loader_valid, glo_loader_valid, label_valid):
    ...
    with torch.no_grad():
        for batch, (drug, cline, glo_feat, label) in enumerate(
            zip(drug_loader_valid, cline_loader_valid, glo_loader_valid, label_valid)
        ):
...
#         cv_data.iloc[train_index, :],
#         cv_data.iloc[validation_index, :],
#     )
...
#         rmse, r2, pcc, all_maps = validation(
#             drug_loader_valid, cline_loader_valid, glo_loader_valid, label_valid
#         )
#         print(
#             "valid-RMSE:"
#             + str(round(rmse, 4))
